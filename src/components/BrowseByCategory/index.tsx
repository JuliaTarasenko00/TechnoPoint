...
export const BrowseByCategory = () => {
  return (
    <section className="  bg-[#fafafa]  ">
      <div className="container px-[160px] pt-[50px] pb-[80px]">
        <h3 className=" text-[24px] font-medium leading-[133%] text-[#000]">
          Browse By Category
        </h3>
        <ul className=" flex items-center justify-center gap-[32px] mt-[32px] text-[#000]">
          {categories.map(({ category, img: Element }) => {
            return (
              ...
              >
                <div className="absolute bg-[#ededed] rounded-[13px] w-full h-full transition-transform duration-500 group-hover:scale-[1.03]"></div>

                <div className="relative group z-10 flex flex-col items-center gap-[14px]">
                  <div className="w-[38px] h-[38px]  transition-transform duration-500 group-hover:scale-[1.1]">
                    <Element />
                  </div>
